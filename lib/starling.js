...
exports.getData = async(requestType) => {
    ...
    case constants.GETMERCHANT:
        return data.getData(apiKey, `merchants/${params.merchantID}`);
    case constants.GETMERCHANTLOCATION:
        return data.getData(apiKey, `merchants/${params.merchantID}/locations/${params.merchantLocationID}`);
    case constants.GETALLSAVINGGOALS:
        return data.getData(apiKey, 'savings-goals');
    case constants.GETGOALBYID:
        return data.getData(apiKey, `savings-goals/${params.savingsGoalID}`);
    case constants.GETGOALSRECURRINGTRANSFERS:
        return data.getData(apiKey, `savings-goals/${params.savingsGoalID}/recurring-transfer`);
    case constants.GETGOALPHOTO:
        return data.getData(apiKey, `savings-goals/${params.savingsGoalID}/photo`);
