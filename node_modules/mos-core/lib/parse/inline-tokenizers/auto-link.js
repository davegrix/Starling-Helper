...
function tokenizeAutoLink(parser, value, silent) {
  ...
  while (index < length) {
    ...
    if (character === ' ' || character === '>' || character === '@' || character === ':' && value.charAt(index + 1) === '/') {
      break;
    }
  ...
  var parserWithNoEscape = (0, _assign2.default)({}, parser, {
  ...
  return parserWithNoEscape.renderLink(true, (0, _parseEntities2.default)(link), content, null, now, parserWithNoEscape.eat).then(function (node) {
...
exports.default = tokenizeAutoLink;
