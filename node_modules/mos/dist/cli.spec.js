  ...
  (0, _mocha.describe)('test', function () {
    (0, _mocha.it)('should pass markdown that is up to date', function () {
      return mos(['test', 'up-to-date.md', '--tap'], {
        ...
        return (0, _chai.expect)(result.stdout).to.eq(['TAP version 13', '# markdown', 'ok 1 up-to-date.md', '', '1..1', '# tests 1', '# pass  1', '', '# ok', ''].join('\n'));
      });
    });
    ...
    (0, _mocha.it)('should use custom options for third-party plugins', function () {
      return mos(['test', 'plugin-options.md', '--tap'], {
        ...
        return (0, _chai.expect)(result.stdout).to.eq(['TAP version 13', '# markdown', 'ok 1 plugin-options.md', '', '1..1', '# tests 1', '# pass  1', '', '# ok', ''].join('\n'));
      });
    });
    ...
    (0, _mocha.it)('should disable default plugin', function () {
      return mos(['test', 'disable-default-plugin.md', '--tap'], {
        ...
        return (0, _chai.expect)(result.stdout).to.eq(['TAP version 13', '# markdown', 'ok 1 disable-default-plugin.md', '', '1..1', '# tests 1', '# pass  1', '', '# ok', ''].join('\n'));
      });
    });
  });
});